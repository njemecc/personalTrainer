  ...
  return (
    ...
    >
      ...
      >
        {title || (
          <span>
           Tvoj lično skrojeni trening uvek sa tobom. <br />Na bilo kom uredjaju.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src="https://media.istockphoto.com/id/1250922872/photo/personal-trainer-giving-online-streaming-during-new-normal.jpg?s=612x612&w=0&k=20&c=f4-pqzjdYM9qh3sQY3KDO9MnRvRYApqP5aTjami7mvs="
          alt="aceternity logo"
          fill
