...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-40 mx-auto my-auto relative w-full justify-center flex flex-col lg:items-end  max-w-xl px-4 lg:mx-auto md:ml-auto md:mr-0 md:mb-auto md:mt-20 md:px-0 lg:px-8 lg:max-w-screen-xl">
