...
import { FaFilePdf, FaFileWord, FaFileAlt, FaDownload, FaTrash, FaCloudUploadAlt } from "react-icons/fa";
...
const UploadPlanIshrane = ({ onUploadComplete }: UploadPlanIshraneProps) => {
    ...
    const getFileIcon = (fileType: string) => {
        ...
        if (fileType.includes("word") || fileType.includes("msword")) return <FaFileWord className="text-blue-500 text-3xl" />;
                        ...
                        <div className="p-5 border border-amber-200 dark:border-amber-800 rounded-lg bg-amber-50 dark:bg-gray-800 shadow-sm">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1 truncate">
                                    <p className="font-bold text-gray-800 dark:text-gray-200">{uploadedFile.name}</p>
